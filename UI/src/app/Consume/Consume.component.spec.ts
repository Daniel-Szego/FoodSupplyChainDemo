...
describe('ConsumeComponent', () => {
  ...
  let mockConsumeService;
  let mockDataService

  beforeEach(async(() => {

    mockConsumeService = sinon.createStubInstance(ConsumeService);
    mockConsumeService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ConsumeService, useValue: mockConsumeService },
